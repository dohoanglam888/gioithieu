...
<meta content='Xây dựng và phát triển bởi Đỗ Hoàng Lâm !' property='og:description'/>
...
<div class='profile-card__name'>Đỗ Hoàng Lâm <i class='fa fa-check-circle' style='color:rgb(17, 143, 249)' title='Verified Author'></i>
</div>
<div class='profile-card__txt'>Tôi là <b>Đỗ Hoàng Lâm</b>, một cậu sinh học sinh cấp 2 chuyên <b>Hỗ trợ Dịch vụ Mạng Xã Hội</b> với ước mơ trở thành một Developer chuyên nghiệp. Tôi thích khám phá, tìm tòi và học hỏi những điều thú vị trên mạng Internet. Biết đôi chút về <i>C++/Python, HTML /CSS, PHP</i> ...</div>
<div class='profile-card-loc'>
<span class='profile-card-loc__icon'>
<svg class='icon'><use xlink:href='#icon-location'></use></svg>
</span>
<span class='profile-card-loc__txt'>Đắk Lắk</span>
</div>
...
<a class='profile-card-social__item facebook' href='https://www.facebook.com/dhl.user'target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-facebook'></use></svg>
</span>
</a>
<a class='profile-card-social__item link' href='https://dohoanglam.github.io' target='_blank'>
<span class='icon-font'>
